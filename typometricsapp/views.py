...
def typo(request):
    ...
    if request.method == 'GET':
        ...
        if axtypes:
            jsondata, nblang, xymin, xymax, xlimMin, freqMax = tsv2jsonNew(
                axtypes,
                request.data.get('ax', ''),
            ...
            return Response({'chartdata': jsondata, 'nblang': nblang, 'xymin': xymin, 'xymax': xymax, 'xlimMin':xlimMin, 'freqMax':freqMax})
        else:
